...
<div id="container">
  <table>
    <tr>
      <td colspan="8" align="center" class="header-surat"  style="padding-bottom:0;margin-bottom:0;">
        <h2 style="padding-bottom:0;margin-bottom:0;">
          TIM VERIFIKASI DAN PETUGAS PENGUKUR LAHAN <br>
          DESA <?php echo strtoupper($data['nama_desa']); ?>
          KECAMATAN <?php echo strtoupper($data['nama_kecamatan']); ?>          
        </h2>
    ...
    <tr>
      <td colspan="8" align="center">
        <h3 style="padding-bottom:0;margin-bottom:0;"><u>Surat Keterangan / Rekomendasi</u><br>Penerbitan Surat Keterangan Tanah (SKT)<br>
        Nomor :<i style="font-weight: lighter;font-family: Consolas, Monaco, Courier New, Courier, monospace;"> <?php echo "181/".$data['id']."-REKOMENDASI/KTD.".strtoupper($data['nama_desa'])."/".romawi(mdate("%m",$data['time']))."/".mdate("%Y",$data['time']);?></i></h3>
      </td>
    </tr>
  </table>
  <table>
