  ...
  <div class="col-md-8">
    ...
    <div class="box box-info">
      ...
      <div class="box-footer">
        <?php if($titik!=null){
            $n=1;
            foreach ($titik->result() as $value) {
              echo $n.". Data JSON : ".$value->json ."<br>";
              $n++;
            }
          }else{ 
                ...
                <div class="box-body"> 
                  ...
                  <div class="well">
                    ...
                    <div id="patok" class="form-group">
                        <label  class="control-label col-sm-4" for="">File Adm. Tanah Desa (.geojson/.json)</label>
                        <div class="col-sm-8">
                            <input type="file" name="geojson" class="form-control" id="">                        
                        </div>                        
                    </div>                
...
function initialize() {
  ...
  <?php foreach ($titik->result() as $json) { ?>
  map.data.loadGeoJson('<?php echo base_url().GEOJSON.'$json->json';?>');
  <?php }?>
}
