  ...
  <div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">Rekap Data Berita Acara Pemeriksaan </h3>
      </div><!-- /.box-header -->
      <div class="box-body">
        <table style="font-size:11px;" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-bap">
          <thead>
            <tr align="center">
              <td>NIK</td>
              <td>Nama</td>
